...
-   **삭제/비활성 약 처리**:
    ...
    -   약 이름에 `(삭제)` 표시
-   **설명 문구**: "약/영양제 차트는 최근 3개월 기준이며, 막대 색이 진할수록 해당 주에 자주 복용했음을 의미합니다."

### 5.3 6개월 (Monthly Summary)
> **목적**: 장기 복용 지속성 확인
...
-   **특징**:
    -   각 항목별 Row 유지
    -   삭제된 항목은 비활성 색상 + `(삭제)` 표시

### 5.4 전체 (Summary Report)
> **목적**: 전체 복용 이력 요약
