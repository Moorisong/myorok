    ...
    <div className={styles.container}>
      <main className={styles.main}>
        ...
        <section className={styles.section}>
          ...
          <ol>
            <li>서비스는 기본적으로 유료 서비스(이하 "구독")로 제공됩니다.</li>
            <li>최초 가입 시 7일간의 무료 체험 기간이 제공되며, 이 기간 동안 유료 사용자와 동일한 모든 기능을 이용할 수 있습니다.</li>
            <li>무료 체험 종료 후 서비스를 계속 이용하기 위해서는 월 단위 구독이 필요하며, 구독료는 월 3,500원(VAT 포함)입니다.</li>
            <li>구독료 결제는 이용자가 이용하는 앱 마켓(Google Play Store)의 정책 및 결제 수단에 따릅니다.</li>
            <li>구독을 하지 않거나 구독이 만료된 경우, 서비스의 주요 기능(기록 조회, 신규 기록 작성, 통계, 쉼터 등) 이용이 제한됩니다. 단, 설정 메뉴 접근 및 구독 결제는 가능합니다.</li>
          </ol>
        </section>
        ...
        <section className={styles.section}>
          ...
          <ol>
            ...
            <li>구독 취소 및 환불은 각 앱 마켓의 정책에 따르며, 회사는 이에 대해 직접적인 권한을 가지지 않습니다.</li>
          </ol>
        </section>
