...
import { reportComment } from '../services';
import { useToast } from './ToastContext';

interface ComfortCommentReportModalProps {
    visible: boolean;
    commentId: string | null;
    onClose: () => void;
}

export default function ComfortCommentReportModal({
    visible,
    commentId,
    onClose,
}: ComfortCommentReportModalProps) {
                    ...
                    <TouchableWithoutFeedback>
                        <View style={styles.contentContainer}>
                            <View style={styles.header}>
                                <Text style={styles.title}>댓글 신고</Text>
                                <Text style={styles.subtitle}>이 댓글을 신고하는 이유를 선택해 주세요.</Text>
                            </View>
